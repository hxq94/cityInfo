...
<body>
    <center>
        <table border="0" width="670" cellspacing="0" cellpadding="0" style="margin-top:5px">
            <tr height="30"><td style="text-indent:5px" valign="bottom"><font color="#004790"><b>■查询结果</b></font></td></tr>
                        	...
                        	<c:otherwise>
                        		<c:forEach var="searchInfo" items="${searchInfoList }" varStatus="status">
                        			<c:choose>
		                        		...
		                        		<td align="center"><a href="/info/show-details-info.do?id=${searchInfo.id}">${searchInfo.title }</a></td>
		                        		<%--<td align="center">${searchInfo.infoDate }</td>--%>
                                    <td align="center"><fmt:formatDate value="${searchInfo.infoDate }" pattern="yyyy-M-d HH:mm:ss" /></td>
