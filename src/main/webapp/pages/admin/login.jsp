                ...
                <tr height="180">
                    <td background="images/logon_middle.gif" align="center" valign="top">
                         <table border="0" width="90%" cellspacing="0" cellpadding="0">
                             <tr height="50"><td colspan="2" align="center"><font color="red">${errorMsg }</font></td></tr>
                             <tr height="30">
                                 <td align="right" width="40%">用户名：&nbsp;&nbsp;</td>
                                 <td style="text-indent:5px"><input type="text" name="userName" id="userName" value="${user.userName }" size="30"/></td>
                             </tr>                
                             <tr height="30">
                                 <td align="right">密&nbsp;&nbsp;码：&nbsp;&nbsp;</td>
                                 <td style="text-indent:5px"><input type="password" name="password" id="password" value="${user.password }" size="30"/></td>
                             </tr>
                             <tr height="60">
                                 <td></td>
                                 <td>
