        	...
        	<c:choose>
        		<c:when test="${searchInfoList==null || searchInfoList.size()==0 }">
        			<tr height="1"><td></td></tr>
              	    <tr height="200" bgcolor="#F9F9F9"><td colspan="8" align="center" style="border:1px solid"><font color="red"><b>★★对不起，未找到符合条件的信息！★★</b></font></td></tr>
        		</c:when>
        		<c:otherwise>
        		<tr height="30">
                           	...
                           	<c:forEach var="searchInfo" items="${searchInfoList }" varStatus="status">
                            	<tr height="30" bgcolor="#F9F9F9">
                                    ...
                                    <td align="center"><a href="/info/check-info.do?id=${searchInfo.id}">√付费</a></td>
                                     <td align="center"><a href="javascript:deleteInfo('${searchInfo.id}')" onclick="">×删除</a></td>
                                 </tr>
                           	</c:forEach>
