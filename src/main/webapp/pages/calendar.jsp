...
<table width="210" border="0" align="center" cellspacing="1">
    <tr height="25">
        <td colspan="7" align="center" style="border:0 solid"><%=now%> <input type="text"
    ...
    <tr>
        ...
        <td width="30" height="23" align="center" bgcolor="gray" style="border:1 solid"><font
                color="#FFFFFF"><b><%=days[i]%>
        </b></font></td>
        <% } else { %>
        <td width="30" height="23" align="center" style="border:1 solid"><%=days[i]%>
        </td>
        <% }
        }%>
    </tr>
