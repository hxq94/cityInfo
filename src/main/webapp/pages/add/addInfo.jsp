                        ...
                        <td align="center">
                            <table border="0" width="650" rules="all" cellspacing="8">                    
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="title" name="title" value="${info.title }" size="80" maxlength="40"/></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td ><input type="text" id="phone" name="phone" value="${info.phone }" size="55"/></td>
                                </tr>
                                <tr>
                                    <td style="text-indent:10px">联 系 人：</td>
                                    <td><input type="text" id="linkman" name="linkMan" value="${info.linkman }" size="55"/></td>
                                </tr>
                                <tr>
                                    <td style="text-indent:10px">E - mail：</td>
                                    <td ><input type="text" id="email" name="email" value="${info.email }" size="55"></td>
                                </tr>
                            </table>                
                        </td>
                    </tr>
