            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
                <c:choose>
                    <c:when test="${payInfoList==null || payInfoList.size()==0 }">
                        <tr height="30">
                            <td align="center" style="border:1px">★★★ 缴费后，您发布信息就可在这里显示！★★★</td>
                        </tr>
                    </c:when>
                    <c:otherwise>
                        <c:forEach var="payinfo" items="${payInfoList }" varStatus="status">
                            ...
                            <td width="50%">『<b>${payinfo.infoType.typeName}</b>』<a
                                    href="/info/show-details-info.do?id=${payinfo.id}">${payinfo.title }</a></td>
...
<table border="0" width="670" cellspacing="2" cellpadding="0">
    <tr height="35">
        <td colspan="2" style="text-indent:5px" valign="bottom"><font color="#004790"><b>■最新信息</b>『免费专区』</font></td>
    </tr>
    <c:choose>
                    ...
                    <table border="1" cellspacing="0" cellpadding="0" width="332" height="160" rules="none"
                        ...
                        <c:forEach var="subFree" items="${subFreeList }" varStatus="oneStatus">
                            <tr bgcolor="#00B48F" height="30">
                                ...
                                <td style="text-indent:10px"><b><font
                                        color="white">▲${subFree.infoType.typeName }</font></b></td>
                                </c:if>
                            <tr bgcolor="#FAFCF5">
                                <td style="text-indent:3px">★ <a
                                        href="/info/show-details-info.do?id=${subFree.id}">${subFree.title }</a></td>
                            </tr>
                            <c:if test="${oneStatus.last }">
                                <tr height="20" bgcolor="#FAFCF5">
                                    <td align="right"><a
                                            href="/info/get-search-info.do?typeId=${subFree.typeId}">更多...</a>&nbsp;&nbsp;
                                    </td>
                                </tr>
                            </c:if>
                            </tr>
