...
<center>
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr height="20">
            ...
            <td align="right" valign="bottom">
                ...
                <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=602943701&site=qq&menu=yes"><img border="0"
                                                                                                          src="http://wpa.qq.com/pa?p=2:602943701:53"
                                                                                                          alt="点击这里给我发消息"
                                                                                                          title="点击这里给我发消息"/></a>
                &nbsp;
            </td>
                    ...
                    <c:otherwise>
                        <table border="0" width="600">
                            <tr align="center">
                                ...
                                <td width="100"><a href="/info/get-search-info.do?typeId=${infoType.id}"
                                                   style="color:white">${infoType.typeName}</a></td>
    ...
    <table border="0" width="100%" height="90" cellspacing="0" cellpadding="0" style="margin-top:1px">
        <tr>
            <td align="center"><a href="" target="_blank"><img src="images/pcard1.jpg"></a></td>
        </tr>
    </table>
</center>
</body>
